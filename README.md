This project aims to create infrastructure using code. The idea is to create a cloud formation template and then use the cloud formation cli to create the infrastructure.
